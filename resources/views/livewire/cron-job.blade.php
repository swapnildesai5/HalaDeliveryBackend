...
<div>
    ...
    <x-baseview title="{{ __('CRON Job') }} ">
        <div class="p-5 border shadow">
            <p>
                How to setup cron job on your server: <a href="https://bit.ly/3DoNGBm" target="_blank" class="font-bold underline text-primary-500">https://bit.ly/3DoNGBm</a>
            </p>
            <hr class="my-6" />
            <p class="mb-2 text-2xl font-bold">Cron job on Server</p>
            <p class="mb-2">For server cron job setup, copy the text below and paste into your cron job tab on your server</p>
            <div class="space-y-2">
