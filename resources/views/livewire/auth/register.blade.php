                            ...
                            <div x-data="{ tab: window.location.hash ? window.location.hash.substring(1) : 'driver' }" id="tab_wrapper">
                                ...
                                <div x-show="tab === 'driver'">
                                    <form wire:submit.prevent="driverSignUp">
                                        ...
                                        <livewire:component.multiple-media-upload title="{{ setting('page.settings.driverDocumentInstructions', __('Documents')) }}" types="PNG or JPEG" fileTypes="image/*" emitFunction="driverDocumentsUploaded" />
