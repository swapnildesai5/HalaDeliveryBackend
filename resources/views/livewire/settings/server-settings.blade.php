            ...
            <div>
                <x-form action="saveMailSettings">
                    ...
                    <div class="p-2 my-2 bg-gray-100 border border-gray-300 rounded">
                        ...
                        <span class="mx-1"><a href="https://www.mailgun.com/" target="_blank" class="text-xs underline">mailgun.com</a></span>
                        <span class="mx-1"><a href="https://www.sendgrid.com/" target="_blank" class="text-xs underline">sendgrid.com</a></span>
                        <span class="mx-1"><a href="https://www.sendinblue.com/" target="_blank" class="text-xs underline">sendinblue.com</a></span>
                        <span class="mx-1"><a href="https://www.mailjet.com/" target="_blank" class="text-xs underline">mailjet.com</a></span>
                        <span class="mx-1"><a href="https://www.sparkpost.com/" target="_blank" class="text-xs underline">sparkpost.com</a></span>
                    </div>
