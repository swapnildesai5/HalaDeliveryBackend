...
class CommissionReportTable extends BaseReportTable
{
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make(__('Vendor Commission'), 'vendor_commission')->format(function ($value, $column, $row) {
            ...
            Column::make(__('Driver Commission'), 'driver_commission')->format(function ($value, $column, $row) {
                return view('components.table.price', $data = [
                    "model" => $row,
                    "column" => $column,
                    "value" => $value,
